...
SECRET_KEY = 'ks_97(@z3rlhgl*xg(yyugps3#qcuc)2ob^es83-gtm880nt&2'
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, 'pets/static'),
)
...
BOWER_COMPONENTS_ROOT = os.path.join(PROJECT_ROOT, 'pets/static/components')
